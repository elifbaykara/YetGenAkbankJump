...
namespace YetGenAkbankJump.WebApi.Data
{
    ...
    }   //api günün sonunda text döner fakat karşı tarafın anlayacağı formata çevirmeyi tercih ederler. Json formatında bir text döner.

    //200 ==> başarılı işlemler
    //400 ==>  senin isteğin bana ulaştı ama veride ya da isteğinde bir yanlışlık var
}